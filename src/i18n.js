  ...
  resources: {
    en: {
      "property": {
        ...
        "receiveOffers": "I would like to receive offers by email",
...
"admin": {
          ...
          "contactedRequests": "Contacted Requests",
          "pending": "Pending",
          "contacted": "Contacted",
          "closed": "Closed",
          "confirmMarkAsContacted": "Mark this request as contacted?",
          "requestMarkedAsContacted": "Request marked as contacted",
          "noContactRequests": "No contact requests at the moment",
  ...
  "selectPropertyType": "בחר סוג נכס",
        ...
        "admin": {
          ...
          "editProperty": "עריכת דירה - {{propertyTitle}}",
            ...
            "error": "שגיאה",
            "serverError": "שגיאה בשרת – נסה שוב",
            "contactRequests": "בקשות יצירת קשר",
            "totalRequests": "סה״כ בקשות",
            "pendingRequests": "בקשות ממתינות",
            "contactedRequests": "בקשות שנוצר קשר",
            "pending": "ממתין",
            "contacted": "נוצר קשר",
            "closed": "סגור",
            "noContactRequests": "אין בקשות יצירת קשר כרגע",
            ...
            "confirmDelete": "האם אתה בטוח שברצונך למחוק את הבקשה?",
            "requestDeleted": "הבקשה נמחקה בהצלחה!",
            "errorDeletingRequest": "שגיאה במחיקת הבקשה:",
            "backToDashboard": "חזרה לדשבורד",
            "logout": "יציאה",
            "connectionError": "❌ שגיאה בחיבור לשרת",
